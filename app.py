...
# Maximum Heart Rate
max_hr = st.sidebar.slider('Maximum Heart Rate Achieved', min_value=60, max_value=202, step=1)

# Exercise-Induced Angina
exercise_angina = st.sidebar.radio('Exercise-Induced Angina', ['N', 'Y'])

# Oldpeak (ST Depression)
oldpeak = st.sidebar.slider('Oldpeak (ST Depression)', min_value=0.0, max_value=6.2, step=0.1)
